...
NICE * `Cult#founding_year`
  * returns an `Integer` that is the year the cult was founded
BOOM * `Cult#slogan`
  * returns a `String` that is this cult's slogan
YEEHAH * `Cult#recruit_follower`
  * takes in an argument of a `Follower` instance and adds them to this cult's list of followers
SHTOP IT RON * `Cult#cult_population`
  * returns an `Integer` that is the number of followers in this cult
EASEH * `Cult.all`
  * returns an `Array` of all the cults
BIG * `Cult.find_by_name`
  * takes a `String` argument that is a name and returns a `Cult` instance whose name matches that argument
SHAKA * `Cult.find_by_location`
  * takes a `String` argument that is a location and returns an `Array` of cults that are in that location
LAKA * `Cult.find_by_founding_year`
